...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        doneButtonBadgeTextView.setTypeface(ua.itaysonlab.extras.CatogramExtras.getBold());
        ...
        doneButtonTextView.setTypeface(ua.itaysonlab.extras.CatogramExtras.getBold());
